package com.behlole.cms.utilities;
...
public class ResponseMappings {
    ...
    public ResponseEntity<Object> getSuccessMessageWithoutData(String message) {
        Map<String, Object> mappedData = new HashMap<>();
        mappedData.put("body", null);
        mappedData.put("message", message);
        mappedData.put("status", 200);
        return new ResponseEntity<Object>(mappedData, HttpStatus.OK);
    }

    public ResponseEntity<Object> getSuccessMessageWithoutDataAndWithoutMessage() {
        Map<String, Object> mappedData = new HashMap<>();
        mappedData.put("body", null);
        mappedData.put("message", "Data successfully fetched");
        mappedData.put("status", 200);
